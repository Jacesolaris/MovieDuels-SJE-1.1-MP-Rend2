...
static cvarTable_t cvarTable[] = {
	...
	{&cg_hudFiles, "cg_hudFiles", "ui/MovieDuels-hud.txt", CVAR_ARCHIVE},
...
void CG_LoadMenus(const char* menuFile)
{
	...
	if (!f)
	{
		...
		len = cgi_FS_FOpenFile("ui/MovieDuels-hud.txt", &f, FS_READ);
		if (!f)
		{
			cgi_Error(S_COLOR_RED "default menu file not found: ui/MovieDuels-hud.txt, unable to continue!\n");
		}
	}
