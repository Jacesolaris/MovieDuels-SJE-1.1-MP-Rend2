...
static int SV_G2API_CopyGhoul2Instance(void* g2_from, void* g2To, const int modelIndex)
{
...
static qboolean SV_G2API_SetRootSurface(void* ghoul2, const int modelIndex, const char* surface_name)
{
...
static int SV_G2API_GetSurfaceRenderStatus(void* ghoul2, const int modelIndex, const char* surface_name)
{
	CGhoul2Info_v& g2 = *static_cast<CGhoul2Info_v*>(ghoul2);
...
void SV_BindGame(void)
{
	...
	char dllName[MAX_OSPATH] = "MovieDuels-mpgame" ARCH_STRING DLL_EXT;
