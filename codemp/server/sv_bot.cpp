...
==================
*/
static void QDECL BotImport_Print(const int type, char* fmt, ...)
{
	char str[2048];
	va_list argptr;
...
==================
*/
static void BotImport_DebugPolygonShow(const int id, const int color, const int num_points, const vec3_t* points)
{
