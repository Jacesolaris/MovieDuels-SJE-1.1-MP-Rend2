...
static char* CG_NewString(const char* string) {
	char* newb, * new_p;
	int i, l;
...
static void SP_misc_model_static(void)
{
	char* model;
	float angle;
	vec3_t angles;
...
static void SP_misc_skyportal_orient(void)
{
	if (cg_skyOri)
...
static void SP_misc_weather_zone(void)
{
	char* model;
	vec3_t mins, maxs;
...
====================
*/
static qboolean CG_ParseSpawnVars(void)
{
