...
typedef struct cgameImport_s {
	...
	qboolean(*G2API_GetBoltMatrix)					(void* ghoul2, int modelIndex, int bolt_index, mdxaBone_t* matrix, const vec3_t angles, const vec3_t position, int frameNum, qhandle_t* model_list, vec3_t scale);
	qboolean(*G2API_GetBoltMatrix_NoReconstruct)	(void* ghoul2, int modelIndex, int bolt_index, mdxaBone_t* matrix, const vec3_t angles, const vec3_t position, int frameNum, qhandle_t* model_list, vec3_t scale);
	qboolean(*G2API_GetBoltMatrix_NoRecNoRot)		(void* ghoul2, int modelIndex, int bolt_index, mdxaBone_t* matrix, const vec3_t angles, const vec3_t position, int frameNum, qhandle_t* model_list, vec3_t scale);
	...
	qboolean(*G2API_SetSkin)						(void* ghoul2, const int modelIndex, const qhandle_t customSkin, const qhandle_t render_skin);
	...
	qboolean(*G2API_SetBoneAngles)					(void* ghoul2, int modelIndex, const char* boneName, const vec3_t angles, int flags, int up, int right, int forward, qhandle_t* model_list, int blendTime, int current_time);
	qboolean(*G2API_SetBoneAnim)					(void* ghoul2, int modelIndex, const char* boneName, int startFrame, int endFrame, int flags, float animSpeed, int current_time, float setFrame, int blendTime);
	qboolean(*G2API_GetBoneAnim)					(void* ghoul2, const char* boneName, int current_time, float* current_frame, int* startFrame, int* endFrame, int* flags, float* animSpeed, int* model_list, int modelIndex);
	qboolean(*G2API_GetBoneFrame)					(void* ghoul2, const char* boneName, int current_time, float* current_frame, int* model_list, int modelIndex);
	void			(*G2API_GetGLAName)						(void* ghoul2, int modelIndex, char* fillBuf);
	int				(*G2API_CopyGhoul2Instance)				(void* g2_from, void* g2To, int modelIndex);
	...
	qboolean(*G2API_SetRootSurface)					(void* ghoul2, int modelIndex, const char* surface_name);
	...
	int				(*G2API_GetSurfaceRenderStatus)			(void* ghoul2, int modelIndex, const char* surface_name);
