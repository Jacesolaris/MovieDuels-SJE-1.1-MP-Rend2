...
using refexport_t = struct refexport_s
{
	...
	int (*G2API_CopyGhoul2Instance)(const CGhoul2Info_v& g2_from, CGhoul2Info_v& g2To, int modelIndex);
	...
	qboolean(*G2API_GetBoltMatrix)(CGhoul2Info_v& ghoul2, int modelIndex, int bolt_index, mdxaBone_t* matrix,
		...
		vec3_t scale);
	qboolean(*G2API_GetBoneAnim)(CGhoul2Info_v& ghoul2, int modelIndex, const char* boneName, int current_time,
	...
	int (*G2API_GetSurfaceRenderStatus)(CGhoul2Info_v& ghoul2, int modelIndex, const char* surface_name);
	...
	qboolean(*G2API_SetBoneAngles)(CGhoul2Info_v& ghoul2, int modelIndex, const char* boneName, const vec3_t angles, int flags, Eorientations up, Eorientations left, Eorientations forward, qhandle_t* model_list, int blendTime, int acurrent_time);

	qboolean(*G2API_SetBoneAnglesIndex)(CGhoul2Info* ghlInfo, int index, const vec3_t angles, int flags, Eorientations yaw, Eorientations pitch, Eorientations roll, qhandle_t* model_list, int blendTime, int acurrent_time);

	qboolean(*G2API_SetBoneAnglesMatrix)(CGhoul2Info* ghlInfo, const char* boneName, const mdxaBone_t& matrix, const int flags, const qhandle_t* model_list, const int blendTime, const int current_time);

	qboolean(*G2API_SetBoneAnglesMatrixIndex)(CGhoul2Info* ghlInfo, const int index, const mdxaBone_t& matrix, const int flags, qhandle_t* model_list, const int blendTime, const int current_time);

	qboolean(*G2API_SetBoneAnim)(CGhoul2Info_v& ghoul2, int modelIndex, const char* boneName, int startFrame, int endFrame, int flags, float animSpeed, int acurrent_time, float set_frame, int blendTime);
	...
	qboolean(*G2API_SetLodBias)(CGhoul2Info* ghlInfo, int lod_bias);
	qboolean(*G2API_SetNewOrigin)(CGhoul2Info_v& ghoul2, int bolt_index);
	void (*G2API_SetRagDoll)(CGhoul2Info_v& ghoul2, CRagDollParams* parms);
	qboolean(*G2API_SetRootSurface)(CGhoul2Info_v& ghoul2, int modelIndex, const char* surface_name);
