...
XCVAR_DEF(g_botsFile1, "", NULL, CVAR_INIT | CVAR_ROM)
XCVAR_DEF(g_botsFile2, "", NULL, CVAR_INIT | CVAR_ROM)
XCVAR_DEF(g_botsFile3, "", NULL, CVAR_INIT | CVAR_ROM)
...
XCVAR_DEF(ui_menuFilesMP, "ui/MovieDuels-mpmenus.txt", NULL, CVAR_ARCHIVE | CVAR_INTERNAL)
...
XCVAR_DEF(cg_SFXSabersGlowSizeUS, "1.0", NULL, CVAR_ARCHIVE)
XCVAR_DEF(cg_SFXSabersCoreSizeUS, "0.8", NULL, CVAR_ARCHIVE)
...
XCVAR_DEF(cg_SFXSabersCoreSizeTFA, "0.6", NULL, CVAR_ARCHIVE)
