	...
	const qhandle_t render_skin)
{
	if (!ghoul2) return qfalse;
	CGhoul2Info_v& g2 = *static_cast<CGhoul2Info_v*>(ghoul2);
	return re->G2API_SetSkin(g2, modelIndex, customSkin, render_skin);
}
	...
	const int modelIndex)
{
	if (!ghoul2) return qfalse;
	CGhoul2Info_v& g2 = *static_cast<CGhoul2Info_v*>(ghoul2);
	return re->G2API_GetBoneAnim(g2, modelIndex, boneName, current_time, current_frame, startFrame, endFrame, flags,
	...
	int* model_list, const int modelIndex)
{
	...
	return re->G2API_GetBoneAnim(g2, modelIndex, boneName, current_time, current_frame, &iDontCare1, &iDontCare2,
...
static int CL_G2API_CopyGhoul2Instance(void* g2_from, void* g2To, const int modelIndex)
{
	if (!g2_from || !g2To) return 0;

	return re->G2API_CopyGhoul2Instance(*static_cast<CGhoul2Info_v*>(g2_from), *static_cast<CGhoul2Info_v*>(g2To),
		modelIndex);
}

static void CL_G2API_CopySpecificGhoul2Model(void* g2_from, const int modelFrom, void* g2To, const int modelTo)
{
	if (!g2_from || !g2To) return;
	re->G2API_CopySpecificG2Model(*static_cast<CGhoul2Info_v*>(g2_from), modelFrom, *static_cast<CGhoul2Info_v*>(g2To),
		modelTo);
}

static void CL_G2API_DuplicateGhoul2Instance(void* g2_from, void** g2To)
{
#ifdef _FULL_G2_LEAK_CHECKING
	g_G2AllocServer = 0;
#endif
...
static qboolean CL_G2API_SetRootSurface(void* ghoul2, const int modelIndex, const char* surface_name)
{
	if (!ghoul2) return qfalse;
	return re->G2API_SetRootSurface(*static_cast<CGhoul2Info_v*>(ghoul2), modelIndex, surface_name);
}
...
static int CL_G2API_GetSurfaceRenderStatus(void* ghoul2, const int modelIndex, const char* surface_name)
{
	if (!ghoul2) return -1;
	CGhoul2Info_v& g2 = *static_cast<CGhoul2Info_v*>(ghoul2);
	return re->G2API_GetSurfaceRenderStatus(g2, modelIndex, surface_name);
}
...
void CL_BindCGame(void)
{
	...
	char dllName[MAX_OSPATH] = "MovieDuels-cgame" ARCH_STRING DLL_EXT;
