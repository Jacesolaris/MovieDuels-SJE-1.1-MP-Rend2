...
#define PRODUCT_NAME			"MovieDuels-MP"

#define CLIENT_WINDOW_TITLE "MovieDuels-MP (MP)"
...
#define BLASTERMISHAPLEVEL_OVERLOAD	   16
#define BLASTERMISHAPLEVEL_MAX         15
#define BLASTERMISHAPLEVEL_FOURTEEN    14
#define BLASTERMISHAPLEVEL_FULL		   13
...
typedef enum
{
	...
	GENCMD_USE_SEEKER,                  //HI_SEEKER
	GENCMD_USE_SHIELD,                  //HI_SHIELD
	GENCMD_USE_MEDPAC,                  //HI_MEDPAC
	GENCMD_USE_MEDPAC_BIG,              //HI_MEDPAC_BIG
	GENCMD_USE_ELECTROBINOCULARS,       //HI_BINOCULARS
	GENCMD_USE_SENTRY,                  //HI_SENTRY_GUN
	GENCMD_USE_JETPACK,                 //HI_JETPACK

	GENCMD_USE_HEALTHDISP,              //HI_HEALTHDISP
	GENCMD_USE_AMMODISP,                //HI_AMMODISP
	GENCMD_USE_EWEB,                    //HI_EWEB
	GENCMD_USE_CLOAK,                   //HI_CLOAK

	GENCMD_FLAMETHROWER,                //HI_FLAMETHROWER
	GENCMD_USE_SWOOP,                   //HI_SWOOP
	GENCMD_USE_DECCA,                   //HI_DROIDEKA
	GENCMD_USE_SPHERESHIELD,            //HI_SPHERESHIELD

	GENCMD_USE_GRAPPLE,                 //HI_GRAPPLE
