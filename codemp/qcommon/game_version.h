...
#define VERSION_INTERNAL_BUILD		09  // Build number

#define VERSION_STRING				"Day-22,Month-03,Year-24,BuildNum-09" // build date
#define VERSION_STRING_DOTTED		"Day-22,Month-03,Year-24,BuildNum-09" // build date
