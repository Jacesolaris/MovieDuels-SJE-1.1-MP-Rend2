...
#define VERSION_INTERNAL_BUILD		09  // Build day

#define VERSION_STRING				"Day-09,Month-05,Year-24,BuildNum-03" // build date
#define VERSION_STRING_DOTTED		"Day-09,Month-05,Year-24,BuildNum-03" // build date
