...
#define VERSION_INTERNAL_BUILD		10  // Build number

#define VERSION_STRING				"Day-24,Month-03,Year-24,BuildNum-10" // build date
#define VERSION_STRING_DOTTED		"Day-24,Month-03,Year-24,BuildNum-10" // build date
