...
#define VERSION_INTERNAL_BUILD		08  // Build day

#define VERSION_STRING				"Day-08,Month-05,Year-24,BuildNum-02" // build date
#define VERSION_STRING_DOTTED		"Day-08,Month-05,Year-24,BuildNum-02" // build date
