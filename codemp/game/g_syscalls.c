...
qboolean trap_G2API_GetBoltMatrix(void* ghoul2, const int modelIndex, const int bolt_index, mdxaBone_t* matrix,
	...
	vec3_t scale)
{
	return Q_syscall(G_G2_GETBOLT, ghoul2, modelIndex, bolt_index, matrix, angles, position, frameNum, model_list,
		scale);
}
...
{
	return Q_syscall(G_G2_GETBOLT_NOREC, ghoul2, modelIndex, bolt_index, matrix, angles, position, frameNum, model_list,
		scale);
}
...
{
	return Q_syscall(G_G2_SETSKIN, ghoul2, modelIndex, customSkin, render_skin);
}
...
{
	return Q_syscall(G_G2_ANGLEOVERRIDE, ghoul2, modelIndex, boneName, angles, flags, up, right, forward, model_list,
...
{
	return Q_syscall(G_G2_GETBONEANIM, ghoul2, boneName, current_time, current_frame, startFrame, endFrame, flags,
...
{
	return Q_syscall(G_G2_COPYGHOUL2INSTANCE, g2_from, g2To, modelIndex);
}

void trap_G2API_CopySpecificGhoul2Model(void* g2_from, const int modelFrom, void* g2To, const int modelTo)
{
	Q_syscall(G_G2_COPYSPECIFICGHOUL2MODEL, g2_from, modelFrom, g2To, modelTo);
}

void trap_G2API_DuplicateGhoul2Instance(void* g2_from, void** g2To)
{
	Q_syscall(G_G2_DUPLICATEGHOUL2INSTANCE, g2_from, g2To);
}
...
{
	return Q_syscall(G_G2_SETROOTSURFACE, ghoul2, modelIndex, surface_name);
}
...
{
	return Q_syscall(G_G2_GETSURFACERENDERSTATUS, ghoul2, modelIndex, surface_name);
}
