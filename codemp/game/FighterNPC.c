...
static void FighterYawAdjust(const Vehicle_t* p_veh, const playerState_t* rider_ps, const playerState_t* parent_ps)
{
...
static void FighterPitchAdjust(const Vehicle_t* p_veh, const playerState_t* rider_ps, const playerState_t* parent_ps)
{
