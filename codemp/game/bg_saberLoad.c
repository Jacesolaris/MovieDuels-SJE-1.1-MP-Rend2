...
qboolean WP_UseFirstValidSaberStyle(const saberInfo_t* saber1, const saberInfo_t* saber2, const int saberHolstered, int* saber_anim_level)
{
...
qboolean WP_SaberStyleValidForSaber(const saberInfo_t* saber1, const saberInfo_t* saber2, const int saberHolstered, int saber_anim_level)
{
	qboolean saber1Active, saber2Active;
	qboolean dualSabers = qfalse;
...
void WP_SetSaber(const int entNum, saberInfo_t* sabers, const int saberNum, const char* saberName)
{
	if (!sabers)
	{
		return;
