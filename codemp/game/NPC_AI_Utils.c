...
static int AI_ClosestGroupEntityNumToPoint(const AIGroupInfo_t* group, vec3_t point)
{
...
static void AI_DeleteGroupMember(AIGroupInfo_t* group, const int member_num)
{
